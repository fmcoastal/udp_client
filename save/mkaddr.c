 ...
 void printadr(char* varname,void *addr)
{
   ...
   printf("    %s->sin_family: %d\n",varname,ap->sin_family);
   printf("    %s->sin_port: %d\n",varname,ap->sin_port);
   printf("    %s->sin_addr.s_addr: %d.%d.%d.%d\n",varname,
                           (ap->sin_addr.s_addr >>24 & 0xff) ,
                           (ap->sin_addr.s_addr >>16 & 0xff), 
                           (ap->sin_addr.s_addr >>8 & 0xff), 
                           (ap->sin_addr.s_addr >>0 & 0xff) );
}
